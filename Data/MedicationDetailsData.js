window.MedicationDetailsData =
    ...
    'midazolam-versed': {
        ...
        contraindications: ["Known hypersensitivity", "Hypotension (SBP <100 mmHg) probabky relative??", "Acute angle glaucoma (relative)"],
    ...
    'ntg': {
        ...
        contraindications: ["Known hypersensitivity", "SBP <100", "Recent use of a phosphodiesterase type 5 inhibitor (sildenafil [Viagra, Revatio] or vardenafil [Levitra] within 24 hours or tadalafil [Cialis, Adcirca]) c̅in 36 hours.", "Right ventricular infarction (RVI)", "Tachycardia (HR>100) in the absence of HF (not universal)", "↑ICP"],
    ...
    'ondansetron-zofran': {
        ...
        class: "Antiemetic",
        indications: ["N/V"],
        contraindications: ["Known hypersensitivity", "Prolonged QTI (male >440msec, female >450msec (probably more of a precaution)", "Pregnancy (1st trimester)"],
