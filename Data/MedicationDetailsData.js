...
const MedicationDetailsData = [{
        ...
        "class": 'Electrolyte',
        indications: ['Hyperkalemia', 'Symptomatic ↓HR', 'Toxic Ingestion'], // Changed 'Symptomatic ↑HR' to 'Symptomatic ↓HR' (corrected indication)
        ...
        adultRx: ['[[Mg OD|from Bronchospasm in Eclampsia]] Rx: 1g IV','Hyperkalemia Rx: 1g IVP/IO', 'Calcium channel blocker OD Rx: Consult to give 1g IVP/IO'], // Replaced missing text placeholder with Calcium channel blocker OD info
        ...
        precautions: 'Rx slowly unless: Cardiac Arrest.',
        sideEffects: ['↓HR','VF','Extravasation Necrosis','Abdominal Pain', 'N/V'],
        adultRx: ['[[Mg OD|from Bronchospasm in Eclampsia]] Rx: 1g IV','Hyperkalemia Rx: 1g IVP/IO', 'text is missing here!!!!!!!'],
        pediatricRx: ['{{red:Don’t give Calcium Chloride to Pediatric pts}}']
  
    {
        ...
        contraindications: ["Hypersensitivity or local anesthetic allergy in the amide class", "AV block >1º in the absence of a pacemaker", "Idioventricular escape rhythm s̄ a pacemaker", "Stokes-Adams syndrome", "WPW syndrome"], // Added missing 'a' for clarity in 's̄ pacemaker'
        precautions: "[[Give ↓ Maintenance Infusions for:|Prolonged plasma half-life]] >70yo, CHF, or hepatic failure.\nDon’t Rx if idioventricular escape rhythm s̄ a pacemaker is present.", // Added missing 'a' for clarity in 's̄ pacemaker'
        ...
        class: "Antiarrhythmic",
        indications: ["Symptomatic ↑HR & VF/pVT"],
        contraindications: ["Hypersensitivity or local anesthetic allergy in the amide class", "AV block >1º in the absence of a pacemaker", "Idioventricular escape rhythm s̄ pacemaker", "Stokes-Adams syndrome", "WPW syndrome"],
   ...
   
    {
        ...
        indications: ["[[Fall or Weakness|probably only for suspected hyperkalemia]]", "Hyperkalemia", "Symptomatic ↑HR", "Toxic Ingestion"],
...

    {
        ...
        precautions: "",
        sideEffects: ["↑HR", "Palpitations/cardiac ectopy", "Tremor", "H/A", "N/V"],
   ...
   
    {
        ...
        sideEffects: ["Blurred vision (high doses)", "Confusion (high doses)", "[[↑HR|may worsen myocardial ischemia]]", "Acute angle closure [[glaucoma|relative]]"],
  ...
  
    {
        ...
        concentration: "(50mg/ml)",
        class: "Antihistamine (H1)",
        indications: ["Allergic Reaction", "Anaphylaxis", "Toxic Ingestion (probable about treating dystonic reactions)"],
        contraindications: ["Known hypersensitivity", "Narrow angle glaucoma", "Prostatic hypertrophy or bladder neck obstruction"],
        precautions: "The drug of choice for anaphylaxis is Epi, not Benadryl",
        sideEffects: ["Sedation", "↓BP (rare)", "May cause paradoxical excitation in young children"],
        adultRx: ["Intervention: Allergic RXN or c̅ Anaphylaxis p̄ Epi = 50mg IVP", "Continuity: Extrapyramidal RXN from Haldol use = 50mg IVP/IM"],
    ...
    
    {
        ...
        sideEffects: ["↑HR & arrhythmias", "Myocardial ischemia/infarction", "HTN", "Tremor", "Anxiety", "H/A", "N/V"],
        ...
        class: "Endogenous Catecholamine",
        indications: ["VF or pVT", "Symptomatic ↓HR", "Cardiogenic Shock", "Post-ROSC Stabilization"],
        contraindications: ["Known hypersensitivity", "≥ 50yo (asthma) usually for the 1:1,000 for bronchospasm"],
        sideEffects: ["↑HR & arrhythmias", "Myocardial ischemia/infarction", "HTN", "Tremor", "Anxiety", "H/A", "N/V"],
        adultRx: ["Intervention: VF/VT 1mg IVP during CPR"],
        pediatricRx: ["Cardiogenic Shock/Post Arrest Stabilization PEDIATRIC p157- epinephrine 1mcg/kg IO or IVP"]
   
    {
        ...
        class: "Endogenous Catecholamine",
        indications: ["Symptomatic ↓HR", "Cardiogenic Shock", "Post-ROSC Stabilization"],
        contraindications: ["Known hypersensitivity", "≥50yo (asthma)usually for the 1:1,000 for bronchospam"],
        sideEffects: ["↑HR & arrhythmias", "Myocardial ischemia/infarction", "HTN", "Tremor", "Anxiety", "H/A", "N/V"],
        adultRx: ["Push-Dose Epi Preparation: \n   Waste 1ml from NS Flush \n   → Draw 1ml Epi 1:10,000 into NS Flush \n   Concentration = 10mcg/ml & total Epi = 100mcg/Flush", "Epi Continuous Infusion: \n   Waste 10ml from 250ml NS bag \n   → Add 10ml of 1:10,000 Epi into the NS bag \n   = 4mcg/ml Epi Concentration", "Epi Continuous Infusion Drip Rates c̅ 60-Drip (Micro-Drip):\n   2mcg/min = 1gtt/2sec\n   4mcg/min = 1gtt/sec\n   8mcg/min = 2gtts/sec\n   12mcg/min = 3gtts/sec\n   16mcg/min = 4gtts/sec", "Intervention: Symptomatic ↓HR (En route & s̄ hypovolemia) \n   = 10mcg IVP followed by 2mcg/min Infusion\n   Consultation:Titrate up by 2mcg/min q̄ min prn    Max= 16mcg/min", "Intervention: Cardiogenic Shock 10mcg IVP followed by \n   → 2mcg/min Infusion → Titrate up 2mcg/min q̄ min\n   Max = 10mcg/min     SBP Goal ≥90", "Intervention: Post-ROSC Stabilization Infused at 2mcg/min \n   → Titrate up by 2mcg/min q̄ min    Max = 16mcg/min"],
    ...
    
    {
        ...
        indications: ["MI", "Pain Management", "Sickle Cell Crisis"],
        contraindications: ["Known hypersensitivity &  SBP <100"],
        precautions: "Fentanyl should be administered slowly.\nCareful monitoring (including the use of waveform capnography) is warranted when co- administering c̅ benzodiazepines or to pts who have consumed alcohol as these pts are at risk for ventilatory depression.",
        sideEffects: ["Respiratory depression", "↓BP", "Cx Rigidity (Extremely rare c̅ Rapid Rx + Dose >5mcg/kg)"],
        adultRx: ["Intervention: MI/ACS 1mcg/kg slow over 3-5min IVP \n   →Consultation needed for repeated doses", "Intervention: Pain 1mcg/kg slow IVP/IM/IN    Max= 150mcg", "Intervention: Sickle Cell Crisis 1mcg/kg slow IVP   Max = 150mcg"],
        pediatricRx: ["Intervention: Pain 0.5-1mcg/kg IV/IN     Max = 50mcg\n   → Consultation needed for repeated doses", "Consultation: Sickle Cell Crisis 1mcg/kg slow IVP/SQ \n   Max= 50mcg"]
   
    {
        ...
        adultRx: ["Continuity: Bronchospasm = 0.5mg or Duo-Neb"] // Added missing space in 'or Duo-Neb'
    },
   ...
   
    {
        ...
        sideEffects: ["Emergence reaction", "↑HR", "↓BP/HTN", "Hypersalivation", "Laryngospasm", "↑ Intraocular Pressure", "N/V", "Transient apnea (if given rapidly via IV route)"],
    ...
    
    {
        ...
        precautions: "Ketorolac Tx is not indicated for abdominal/chest pain.\n↓ By 50% in pts >65yo due to ↓ Renal Function Concerns", // Replaced 'Cx' with 'chest' for clarity
        ...
        indications: ["Pain Control for pts >17yo"],
        contraindications: ["Known hypersensitivity", "Allergy to any NSAID (including ASA)", "Asthma", "Renal insufficiency", "Peptic ulcer disease or GI bleeding", "Pregnancy", "Hypovolemia", "Trauma other than isolated extremity trauma", "Anticipated major surgery (within 7 days)"],
        precautions: "Ketorolac Tx is not indicated for abdominal/Cx pain.\n↓ By 50% in pts >65yo due to ↓ Renal Function Concerns",
        sideEffects: ["GI bleeding", "H/A", "Drowsiness", "Abdominal pain", "Dyspepsia"],
    ...
    
    {
        ...
        class: "Benzo",
        indications: ["SAI", "Symptomatic ↓HR", "Seizure", "Symptomatic ↑HR", "Vent Pt", "Violent/Combative Pt"],
        ...
        precautions: "Respiratory Depression Risk c̅ Opioids, old age, or c̅ Respiratory Conditions. ↓ Rx c̅ in these pts.\nRx c̅ a non-intubated pt → Monitor the airway & ventilation \n   → Use Capno.\n↓BP may occur c̅ fast Rx to low volume pts, or to pts c̅ hemodynamic instability.",
        ...
        precautions: "Respiratory Depression Risk c̅ Opioids, old age, or c̅ Respiratory Conditions. ↓ Rx c̅ in the
        sideEffects: ["Respiratory depression", "↓BP", "Confusion"],
        adultRx: ["Intervention: ↓HR c̅ ↓BP If → Pacing Works + Uncomfortable pt \n   = 5mg  IV/IO", "Intervention: ↑HR c̅ ↓BP = 5mg IV/IO ā Cardioversion  if  IV", "Intervention: Vent pt c̅ ↓BP = 5mg IV/IO", "Intervention: RASS +1 Adult ≤65yo = 0.02mg/kg IV\n   Single Max Dose = 2.5mg IV or 5mg IM", "Consultation: RASS+4 p̄ Ketamine or RASS+1 Adult ≤65yo \n   = 5mg IM", "Intervention: SAI = 2.5-5mg IV", "Intervention: Seizure = 10mg IM or 0.1mg/kg IV/IN \n   Max = 5mg IV & 10mg IM", "Intervention: Seizure from Organophosphate OD = 5mg IV/IN"],
        pediatricRx: ["Intervention: SAI = 0.1mg/kg IV       Max = 5mg", "Intervention: Seizure = 0.5mg/kg  IN \n   Initial Max =10mg & Total Dose Max = 20mg\n   or 0.2mg/kg  IV/IO  c̅  Max = 5mg & prn until Total Max = 10mg IV", "Intervention: Seizure from Organophosphate OD \n   = 0.2mg/kg  IV/IO      Max = 5mg\n   or 0.5mg/kg  IN", "Intervention: RASS+3 “safety or ↑ physical restraint” \n   =   0.1-0.2mg/kg  IM        Max = 5mg  IM\n   or
    ...
    },
    {
        ...
        contraindications: ["Known hypersensitivity", "SBP <100", "Recent use of a phosphodiesterase type 5 inhibitor (sildenafil [Viagra, Revatio] or vardenafil [Levitra] within 24 hours or tadalafil [Cialis, Adcirca]) within 36 hours.", "Right ventricular infarction (RVI)", "Tachycardia (HR>100) in the absence of HF (not universal)", "↑ICP"],
        precautions: "Pts c̅ RVI are preload sensitive & can develop severe ↓BP in response to Preload-reducing agents. If ↓BP develops following Rx → IVF may be necessary.\nInferior STEMI → Do right sided EKG to look for RVI evidence\nPts c̅ aortic stenosis are very preload dependent to maintain cardiac output. NTG c̅ aortic stenosis or murmur should be judicious & carefully titrated.",
