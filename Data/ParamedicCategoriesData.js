...
window.ParamedicCategoriesData = [
  {
    id: slugify("Abbreviations & References"), 
    title: "Abbreviations & References", 
    type: "category", 
    children: [
      { 
        id: slugify("Abbott Approved Abbreviations"), 
        title: "Abbott Approved Abbreviations", 
        type: "topic" 
      },{ 
        id: slugify("Other Abbreviations"), 
  ...
  {
    id: slugify("Introduction & Core Principles"), 
    title: "Introduction & Core Principles", 
    type: "category", 
    children: [
      { 
        id: slugify("Introduction to Abbott"), 
        title: "Introduction to Abbott", 
        type: "topic" 
      },{ 
        id: slugify("Core Principles – Safety & Well-Being"), 
        title: "Core Principles – Safety & Well-Being", 
        type: "topic" 
      },{ 
        id: slugify("General Important Information"), 
  ...
  {
    id: slugify("Administrative & Legal Essentials"), 
    title: "Administrative & Legal Essentials", 
    type: "category", 
    children: [
      { 
        id: slugify("ALS Ground Rules"), 
        title: "ALS Ground Rules", 
        type: "topic" 
      },{ 
        id: slugify("Scope Violations & Possible Consequences"), 
        title: "Scope Violations & Possible Consequences", 
        type: "topic" 
      },{ 
        id: slugify("Suspension/Revocation"),
         title: "Suspension/Revocation", 
         type: "topic" 
      },{ 
        id: slugify("On-Scene Authority"), 
        title: "On-Scene Authority", 
        type: "topic" 
      },{ 
        id: slugify("On-Scene Healthcare Professionals"), 
        title: "On-Scene Healthcare Professionals", 
        type: "topic" 
      },{ 
        id: slugify("Dispatching MD [200]"), 
        title: "Dispatching MD [200]", 
        type: "topic" 
      },{ 
        id: slugify("Consulting OLMC"), 
        title: "Consulting OLMC", 
        type: "topic" 
      },{ 
        id: slugify("Transfer to Lesser Credential"), 
        title: "Transfer to Lesser Credential", 
        type: "topic" 
      },{ 
        id: slugify("EMR Accompanying Critically Ill"), 
        title: "EMR Accompanying Critically Ill", 
        type: "topic" 
      },{ 
        id: slugify("Response Mode"), 
        title: "Response Mode", 
        type: "topic" 
      },{ 
        id: slugify("AIR AMBULANCE UTILIZATION"), 
        title: "AIR AMBULANCE UTILIZATION", 
        type: "topic" 
      },{ 
        id: slugify("Applicability of the COG"), 
        title: "Applicability of the COG", 
        type: "topic" 
      },{ 
        id: slugify("Mandatory Reporting"), 
        title: "Mandatory Reporting", 
        type: "topic" 
      },{ 
        id: slugify("Crime Scene"), 
        title: "Crime Scene", 
        type: "topic" 
      },{ 
        id: slugify("Worker’s Compensation Process"), 
  ...
  {
    id: slugify("Operational Protocols"), 
    title: "Operational Protocols", 
    type: "category", 
    children: [
      { 
        id: slugify("Restraint of Agitated/Combative Patients"), 
        title: "Restraint of Agitated/Combative Patients", 
        type: "topic" 
      },{ 
        id: slugify("Richmond Agitation Sedation Scale (RASS)"), 
        title: "Richmond Agitation Sedation Scale (RASS)", 
        type: "topic" 
      },{ 
        id: slugify("Rule of 9’s & Rule of Palms (BSA Burn Estimation)"), 
        title: "Rule of 9’s & Rule of Palms (BSA Burn Estimation)", 
        type: "topic" 
      },{ 
        id: slugify("Smith-Modified Sgarbossa Criteria"), 
        title: "Smith-Modified Sgarbossa Criteria", 
        type: "topic" 
      },{ 
        id: slugify("PCR Requirements"), 
        title: "PCR Requirements", 
        type: "topic" 
      },{ 
        id: slugify("Clinical Errors & Reporting"), 
        title: "Clinical Errors & Reporting", 
        type: "topic" 
      },{ 
        id: slugify("Medication Administration Cross Check (MACC)"), 
        title: "Medication Administration Cross Check (MACC)", 
        type: "topic" 
      },{ 
        id: slugify("CDC Field Triage Guidelines (Trauma)"), 
        title: "CDC Field Triage Guidelines (Trauma)", 
        type: "topic" 
      },{ 
        id: slugify("Rehabilitation: Emergency Incidents & Municipal Partners"), 
