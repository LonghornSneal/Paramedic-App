...
Design & Feature Overview: The app’s UI elements & features.
  ...
  **[Search Bar: live spiderweb filtering/highlighting & only one location for user input.]**
    ...
    **[Current matching implementation: case-insensitive against topic titles, navigation labels, and associated keywords. Matching branches become more prominent while non-matching branches remain readable, smaller, and faded; broad inherited-path matches are intentionally limited so generic terms do not blow open the entire spiderweb.]**
