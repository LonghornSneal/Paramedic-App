...
<body class="bg-gray-100">
    ...
    <script>
        ...
        function createDetailText(textBlock) { /* enhanced to support toggle-info and red text (with underline) */
            ...
            safeText = safeText.replace(/\{\{redul:(.+?)\}\}/g, (m, text) =>
                `<span class="text-red-600 font-semibold underline">${text}</span>`);
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const medicationDetails = { /* ... All medication details from v0.6 ... */
                ...
                'albuterol': { title: "Albuterol", concentration: "(2.5mg/3cc)", class: "Beta Adrenergic Agonist (β₂ selective)", indications: ["Bronchospasm"], contraindications: ["Known hypersensitivity"], sideEffects: ["↑HR", "Palpitations/Cardiac Ectopy", "Tremor", "H/A", "N/V"], adultRx: ["Intervention: Bronchospasm = 2.5mg in 3cc Neb c̅ O₂  ≥6LPM\n   Continuity→ Repeat Doseor Give Duo-Neb", "Intervention: Hyperkalemia = 2.5mg Neb Given p̄ Ca & Bicarb"], pediatricRx: ["Intervention: Bronchospasm = 2.5mg Neb c̅ O₂ ≥6LPM\n   Continuity → Repeat dose"] },
                'asa': { title: "ASA", concentration: "(81mg/tab)", class: "NSAID", indications: ["MI or ACS"], contraindications: ["Known hypersensitivity", "Environmental hyperthermia ???????", "Peptic ulcer disease (relative for cardiac indications)", "Pediatric/Adolescent → Due to Reye’s Syndrome"], precautions: "Reye’s Syndrome S/S = CNS damage, liver injury, & ↓BGL", sideEffects: ["Gastritis", "N/V", "Upper GI bleeding", "↑ Bleeding"], adultRx: ["Intervention:MI or ACS  = 324mg PO"] },
